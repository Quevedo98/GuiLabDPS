...
//Arreglo del tipo Alumno que tiene 3 registro almacenaos
 alumnoArray: Alumno[] = [
 {id:1, name:"Alex", lastname:"Campos",age:35, addres:"Residencial Metropolis",phone:75456789,email:"ale@gmail.com"},
  {id:2, name:"Maria", lastname:"Lopez",age:20,addres:"Residencial San Gabriel",phone:79636789,email:"lopez@gmail.com"},
  {id:3, name:"Juan", lastname:"Castro",age:25,addres:"Residencial Cidudad Dorada",phone:72466789,email:"castro@gmail.com"}
]
//atributo selecAlumno del tipo Alumno, por lo tanto, puede almacenar un objeto
selectedAlumno: Alumno = {id:0, name:'', lastname:'', age:0, addres:'',phone:12345678, email:'' };
...
//de lo contrario limpia el atributo selectedAlumno en pantalla. [(ngModel)]
 ...
 this.selectedAlumno = {id:0, name: '', lastname: '', age:0, addres:'',phone:12345678, email:'' };
 }
